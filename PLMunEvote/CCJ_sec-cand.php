...
<div class="container">
         ...
         <div class="row">
           ...
           <h1 class="text-center" style="margin-bottom: 10px;">VOTE FOR CCJ SECRETARY</h1>
           <p class="text-center" style="margin-bottom: 50px; font-size: 20px;">Choose 1 To Vote</p>
         </div>
<?php 
   $sql = "select * from candidates
   where deptid= 3 && position='secretary'";
        ...
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-bottom:25px; margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 16rem; background-color: ;">
                 <a href="CCJ_SEC-Confirmation.php"><img class="card-img-top" src="img/pic.jpg" 
                 alt="shinzo" height="150px"></a>
                  <div class="card-body">
                    ...
                    <a href="CCJ_SEC-Confirmation.php" class="btn btn-primary">Vote Now</a>
                  </div>
                </div>
              </div>
              <br><br>
