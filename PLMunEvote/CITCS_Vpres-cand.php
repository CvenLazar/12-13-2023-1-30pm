...
<div class="container">
         ...
         <div class="row">
           ...
           <h1 class="text-center" style="margin-bottom: 10px;">VOTE FOR CITCS VICE-PRESIDENT</h1>
           <p class="text-center" style="margin-bottom: 50px; font-size: 20px;">Choose 1 To Vote</p>
         </div>
<?php 
   $sql = "select * from candidates
   where deptid= 1 && position='vice-president'";
        ...
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-bottom:25px; margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 16rem; background-color: ;">
                 <a href="CITCS_VP-Confirmation.php"><img class="card-img-top" src="img/pic.jpg" 
