...
<?php 
   ...
   where deptid= 2 && position='secretary'";
        ...
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-bottom:25px; margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 16rem; background-color: ;">
                 <a href="CAS_SEC-Confirmation.php"><img class="card-img-top" src="img/pic.jpg" 
                 alt="shinzo" height="150px"></a>
                  <div class="card-body">
                    ...
                    <a href="CAS_SEC-Confirmation.php" class="btn btn-primary">Vote Now</a>
                  </div>
                </div>
              </div>
              <br><br>
