...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                <h1 style="padding-top: 20px;">Student Registration</h1>
                ...
                <tr>
                    ...
                    <tr>
                        <td class="td-1">Middle Name :</td>
                        <td class="td-1"><input   required type="text" style="text-align: left;" name="Mname" autofocus></td>
                    </tr>
                    <tr>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="td-1"><input   required type="date" style="text-align: left;" name="Birthday"></td>
                    </tr>
